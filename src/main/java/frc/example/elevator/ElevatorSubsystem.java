...
import static frc.example.elevator.ElevatorConfig.accelerationFactor;
import static frc.example.elevator.ElevatorConfig.d;
import static frc.example.elevator.ElevatorConfig.g;
import static frc.example.elevator.ElevatorConfig.inchesPerRotation;
import static frc.example.elevator.ElevatorConfig.maxFeedback;
import static frc.example.elevator.ElevatorConfig.maxHeight;
import static frc.example.elevator.ElevatorConfig.maxTeleopVolts;
import static frc.example.elevator.ElevatorConfig.maxVelocity;
import static frc.example.elevator.ElevatorConfig.minHeight;
import static frc.example.elevator.ElevatorConfig.p;
import static frc.example.elevator.ElevatorConfig.presetL1;
import static frc.example.elevator.ElevatorConfig.presetL2;
import static frc.example.elevator.ElevatorConfig.presetL3;
import static frc.example.elevator.ElevatorConfig.tolerance;
import static frc.example.elevator.ElevatorConfig.v;
...
public class ElevatorSubsystem extends SubsystemBase {
    ...
    public ElevatorSubsystem(Motor motor) {
        ...
        SmartDashboard.putData("ElevatorSubsystem", builder -> {
            ...
            builder.addDoubleProperty("VelocityNext", this::getVelocity, null);
    ...
    public Command tuningCommand() {
        ...
        DoubleSupplier pref = Util.pref("ElevatorSubsystem/TuningVelocity", 0.0);
        ...
        return new Command() {
            ...
            public void initialize() {
                ...
                tuningVelocity = pref.getAsDouble();
