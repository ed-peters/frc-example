...
import static frc.example.intake.IntakeConfig.d;
import static frc.example.intake.IntakeConfig.defaultBrakeEnabled;
import static frc.example.intake.IntakeConfig.ejectSeconds;
import static frc.example.intake.IntakeConfig.gearRatio;
import static frc.example.intake.IntakeConfig.p;
import static frc.example.intake.IntakeConfig.collectSpeed;
import static frc.example.intake.IntakeConfig.ejectSpeed;
import static frc.example.intake.IntakeConfig.feedSpeed;
import static frc.example.intake.IntakeConfig.repositionSeconds;
import static frc.example.intake.IntakeConfig.repositionSpeed;
import static frc.example.intake.IntakeConfig.tolerance;
import static frc.example.intake.IntakeConfig.v;
import static frc.example.intake.IntakeConfig.wheelCircumferenceFeet;
